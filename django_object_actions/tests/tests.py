...
class AppTests(LoggedInTestCase):
    ...
    def test_tool_func_gets_executed(self):
        ...
        votes = c.votes
        response = self.client.get(reverse('admin:polls_choice_actions', args=(1, 'increment_vote')))
    ...
    def test_undefined_tool_404s(self):
        response = self.client.get(reverse('admin:polls_poll_actions', args=(1, 'weeeewoooooo')))
